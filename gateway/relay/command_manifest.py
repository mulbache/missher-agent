...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Missher session"),
        ...
        _cmd("status", "Show Missher session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Missher agent"),
        ...
        _cmd("update", "Update Missher Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Missher gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Missher session in it",
