...
from gateway.platforms.yuanbao_proto import (
    CMD_TYPE, WS_HEARTBEAT_RUNNING, WS_HEARTBEAT_FINISH, MISSHER_INSTANCE_ID,
...
_APP_VERSION = _BOT_VERSION = _MISSHER_VERSION
_YUANBAO_INSTANCE_ID = str(MISSHER_INSTANCE_ID)
...
class YuanbaoAdapter(BasePlatformAdapter):
    ...
    # Per Missher home: a multiplexed gateway runs one Yuanbao adapter per profile, and the tools /
    ...
    def get_active(cls) -> Optional["YuanbaoAdapter"]:
        ...
        return cls._active_instances.get(missher_home_key())
    ...
    def set_active(cls, adapter: Optional["YuanbaoAdapter"]) -> None:
        ...
        if get_missher_home_override() is None:
            ...
            cls._active_instances.pop(missher_home_key(), None)
        else:
            cls._active_instances[missher_home_key()] = adapter
