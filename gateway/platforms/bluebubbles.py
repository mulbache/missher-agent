...
# `require_mention: true` without custom aliases uses Missher wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?missher\s+agent\b[,:\-]?", r"(?<![\w@])@?missher\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Missher defaults)."""
