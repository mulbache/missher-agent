...
plugins should use :func:`canonical_whatsapp_identifier` to line up with Missher' session keys.
"""
...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    if not normalized:
        return set()
    session_dir = get_missher_dir("platforms/whatsapp/session", "whatsapp/session")
