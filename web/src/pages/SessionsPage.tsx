...
const SOURCE_CONFIG: Record<string, { icon: typeof Terminal; color: string }> =
  {
    ...
    missher_flow: { icon: Play, color: "text-warning" },
...
const NO_MATCHING_SESSION_SOURCE = "__missher_dashboard_no_matching_source__";
        ...
        const res = await fetch(api.exportSessionUrl(id, rowProfile(id)), {
          ...
          headers: {
            "X-Missher-Session-Token":
              (window as unknown as { __MISSHER_SESSION_TOKEN__?: string })
                .__MISSHER_SESSION_TOKEN__ ?? "",
          },
        });
