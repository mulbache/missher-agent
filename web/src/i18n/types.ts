...
export interface Translations {
  ...
  status: {
    ...
    updateMissherConfirmMessage?: string;
    updateMissherConfirmNow?: string;
    updateMissherConfirmTitle?: string;
    updatingMissher: string;
  ...
  // ── Achievements plugin (plugins/missher-achievements) ──
  achievements: {
    hero: {
      kicker: string;
      title: string;
