...
export const en: Translations = {
  ...
  status: {
    ...
    updateMissherConfirmMessage:
      "This runs missher update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateMissherConfirmNow: "Update now",
    updateMissherConfirmTitle: "Update Missher?",
    updatingMissher: "Updating Missher…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Missher plugins (`missher plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.missher/plugins/?",
    removeHint: "Only user-installed plugins under ~/.missher/plugins can be removed.",
    ...
    catalogEmptyDocsLink: "Learn about Missher plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.missher/skills/",
  ...
  config: {
    configPath: "~/.missher/config.yaml",
    filters: "Filters",
    sections: "Sections",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Missher doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "Missher Achievements",
      subtitle:
        "Collectible Missher badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Missher session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Missher more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Missher sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Missher is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Missher Agent ☤",
    },
  },
