import { applyDocumentLocale, LOCALE_ENDONYMS } from "@missher/shared/i18n";
...
// Display metadata for the language picker — endonyms from @missher/shared so the
...
const STORAGE_KEY = "missher-locale";
