 ...
 *
 * Values come from @missher/shared (missher_constants.VALID_REASONING_EFFORTS
 * plus `none`, thinking-off). An empty/unset config value means the Missher
 * default.
 */
 ...
 *  option. Empty/unknown → `medium` (Missher' default when unset). */
