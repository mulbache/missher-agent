 ...
 *
 * Plugins call window.__MISSHER_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__MISSHER_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__MISSHER_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__MISSHER_PLUGIN_SDK__ = {
    ...
    // window.__MISSHER_SESSION_TOKEN__ directly.
    authedFetch,
