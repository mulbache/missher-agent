/**
 * Missher Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__MISSHER_PLUGIN_SDK__`` and
 * ``window.__MISSHER_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__MISSHER_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``MissherPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@missher/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__MISSHER_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__MISSHER_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__MISSHER_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface MissherPluginSDK {
...
declare global {
  interface Window {
    __MISSHER_PLUGIN_SDK__?: MissherPluginSDK;
    __MISSHER_PLUGINS__?: PluginRegistry;
  }
}
