 ...
 * `window.__MISSHER_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Missher brand in the top bar
 ...
 *  `window.__MISSHER_PLUGINS__.registerSlot(...)`.
 *
