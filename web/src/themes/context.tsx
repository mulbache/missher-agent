...
const STORAGE_KEY = "missher-dashboard-theme";
...
const FONT_STORAGE_KEY = "missher-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `missher_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "missher-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-missher-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-missher-theme-font", "true");
