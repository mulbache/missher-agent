import { parseColor, THEME_PRESET_PALETTES, type ThemePresetPalette } from "@missher/shared";
 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `missher_cli/web_server.py`.
 *
 * Presets that also ship on the desktop (midnight, ember, mono, cyberpunk)
 * take their colours from `@missher/shared` `THEME_PRESET_PALETTES` so both
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Missher Teal",
  description: "Classic dark teal — the canonical Missher look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Missher Teal (Large)",
  description: "Missher Teal with bigger fonts and roomier spacing",
