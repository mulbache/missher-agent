 ...
 *
 * Each entry is a key/value pair that lands in the packaged Missher.app's
 ...
 * "Missher wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Missher wants to access Music" when Missher never touches the Music
