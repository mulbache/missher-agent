"""Session <-> workspace grouping key (missher_state_sessions.workspace_key).

The key is what `missher sessions list --workspace` groups/filters on. It is a
...
import missher_state_sessions
from missher_state_sessions import workspace_key
