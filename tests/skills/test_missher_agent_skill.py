"""The `missher-agent` skill is what a running Missher knows about itself.

`website/` is never packaged, so an installed Missher has no local copy of the
user guide; skills ARE synced into `$MISSHER_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Missher can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "missher-agent"
