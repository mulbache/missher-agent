...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and missher-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # missher-agent (tests/skills/)
]
