...
def _isolate_env(tmp_path, monkeypatch):
    """Ensure MISSHER_HOME and RETAINDB vars are isolated."""
...
class TestRetainDBMemoryProvider:
    ...
    def test_initialize_creates_client_and_queue(self, tmp_path, monkeypatch):
        ...
        p.initialize("test-session", missher_home=str(tmp_path / ".missher"))
...
class TestPrefetch:
    ...
    def _make_initialized_provider(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("MISSHER_HOME", str(missher_home))
        p = RetainDBMemoryProvider()
        p.initialize("test-session", missher_home=str(missher_home))
        return p
