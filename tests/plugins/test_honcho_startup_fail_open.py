...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "missher honcho peer --user", "Do not suggest peerName"),
    ("telegram", "Do not suggest peerName", "missher honcho peer --user"),
])
...
@pytest.mark.parametrize("platform, present, absent", [
    ("cli", "missher honcho peer --user", "could not be initialized"),
    ("discord", "supplied no user id", "missher honcho peer --user"),
])
