...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.missher/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at missher_state import time, before pytest's MISSHER_HOME monkeypatch
    fires — the autouse fixture's MISSHER_HOME override doesn't help here.)
    """
