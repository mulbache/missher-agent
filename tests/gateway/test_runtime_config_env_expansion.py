...
def gateway_home(monkeypatch, tmp_path):
    ...
    monkeypatch.delenv("MISSHER_PREFILL_MESSAGES_FILE", raising=False)
    monkeypatch.delenv("MISSHER_EPHEMERAL_SYSTEM_PROMPT", raising=False)
    ...
    monkeypatch.delenv("MISSHER_BACKGROUND_NOTIFICATIONS", raising=False)
    return tmp_path
