...
class RecordingAdapter:
    ...
    async def send(self, chat_id, content, metadata=None, **kw):
        self.calls.append(("send", str(get_missher_home())))
        return SimpleNamespace(success=True, error=None)

    async def send_private_notice(self, chat_id, user_id, content, metadata=None, **kw):
        self.calls.append(("send_private_notice", str(get_missher_home())))
        return SimpleNamespace(success=True, error=None)

    async def handle_message(self, event):
        self.calls.append(("handle_message", str(get_missher_home())))
...
def test_loop_completion_persists_into_the_served_profiles_store(served):
    ...
    from missher_cli.goals import _get_session_db
