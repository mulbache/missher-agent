"""Tests for _setup_feishu() in missher_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("missher_cli.config.save_env_value", side_effect=mock_save), \
         patch("missher_cli.config.get_env_value", side_effect=mock_get), \
         patch("missher_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("missher_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("missher_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("missher_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("missher_cli.cli_output.print_header"), \
         patch("missher_cli.cli_output.print_info"), \
         patch("missher_cli.cli_output.print_success"), \
         patch("missher_cli.cli_output.print_warning"), \
         patch("missher_cli.cli_output.print_error"), \
