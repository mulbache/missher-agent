...
apps/desktop/src/plugins/missher-bots/canonical-chat-registry.test.ts; here we pin the DB/RPC algebra
...
def home(tmp_path, monkeypatch):
    """Temp MISSHER_HOME so the gateway resolvers read a throwaway state.db.
