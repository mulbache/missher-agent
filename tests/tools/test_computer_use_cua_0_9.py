...
def _make_backend(session: _FakeSession):
    ...
    backend._session_id = "missher-session"
...
def test_backends_are_isolated_by_missher_session_and_reused_within_it():
...
def test_concurrent_missher_sessions_do_not_share_backend_state():
    from tools.computer_use import tool as computer_use
