...
* ``missher_constants.get_missher_dir`` (cache path)
...
def tmp_cache_dir(tmp_path):
    """Override get_missher_dir so cache writes land under tmp_path."""
    ...
    with patch("missher_constants.get_missher_dir", _fake_get):
        yield cache_dir
