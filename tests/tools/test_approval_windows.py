...
must match regardless of host OS (a Linux-hosted Missher can still drive a
...
class TestWindowsPathVariant:
    ...
    @pytest.mark.parametrize("cmd", [
        ...
        r"copy C:\Users\me\AppData\Local\missher\.env D:\exfil\e.txt",
        "cat C:/Users/me/AppData/Local/missher/.env",
    ])
