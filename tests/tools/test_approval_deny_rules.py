...
def clean_env(monkeypatch):
    ...
    for var in ("MISSHER_YOLO_MODE", "MISSHER_GATEWAY_SESSION",
                "MISSHER_CRON_SESSION", "MISSHER_INTERACTIVE",
                "MISSHER_EXEC_ASK"):
...
class TestDenyOrdering:
    ...
    def test_container_backend_cannot_skip_deny(
        ...
        result = guard("chmod 600 /tmp/missher-approval-deny-test", env_type)
