...
def reload_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(_mcp_discovery, "discover_mcp_tools",
                        lambda: discovered_homes.append(missher_constants.missher_home_key()))
...
def test_reload_rediscovers_under_each_live_profile_scope(reload_env):
    ...
    assert missher_constants.missher_home_key() in reload_env.discovered_homes
    assert missher_constants.missher_home_key(reload_env.profile_b) in reload_env.discovered_homes
