"""Tests for MCP tools interactive configuration in missher_cli.tools_config."""

from unittest.mock import patch

from missher_cli.tools_config import _configure_mcp_tools_interactive
...
_CHECKLIST = "missher_cli.curses_ui.curses_checklist"
_SAVE = "missher_cli.tools_config.save_config"
...
def test_disabling_tool_writes_include_list(capsys):
    ...
    catalog flow, `missher mcp configure`, and this UI all write the same
