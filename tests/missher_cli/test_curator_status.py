"""Tests for `missher curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated MISSHER_HOME with real agent-created skills on disk."""
    ...
    from missher_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import missher_cli.curator as curator_cli
