...
only when every damaged object is a Missher FTS shadow.
"""
...
from missher_cli.doctor_report import Finding
from missher_cli.doctor_state import _state_db_health
from missher_state import SessionDB
from missher_state_repair import integrity_damage_is_structural, state_db_has_structural_damage
...
def test_doctor_routes_structural_damage_to_recover_not_fts_rebuild(tmp_path, monkeypatch):
    ...
    .malformed-backup, nothing fixed) and must point at `missher sessions recover` for THIS
