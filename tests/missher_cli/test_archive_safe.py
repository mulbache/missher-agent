"""Tests for the shared tar.gz writer (``missher_cli.archive_safe.make_targz``).

``make_targz`` backs both ``missher profile export`` and ``missher kanban
...
from missher_cli.archive_safe import make_targz
