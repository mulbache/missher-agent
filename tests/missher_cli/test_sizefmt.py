"""Tests for the shared byte formatter (missher_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from missher_cli.backup import _format_size as backup
    from missher_cli.checkpoints import _fmt_bytes as checkpoints
    from missher_cli.sizefmt import format_bytes as doctor
