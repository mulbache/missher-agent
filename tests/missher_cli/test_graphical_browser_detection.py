"""Tests for `_can_open_graphical_browser()` in missher_cli.auth.

Guards the fix for the May 2026 report where `missher auth add xai-oauth`
...
from missher_cli.auth import _can_open_graphical_browser
