...
def test_config_round_trip_uses_canonical_settings_namespace(
    ...
    ctx.set_config("api_url", r"C:\Users\Owner\Missher 🚀")
    ...
    assert settings == {
        "api_url": r"C:\Users\Owner\Missher 🚀",
        "retry": {"policy": {"attempts": 3, "enabled": True}},
    }
    assert ctx.get_config("api_url") == r"C:\Users\Owner\Missher 🚀"
...
"""
    env = dict(os.environ, MISSHER_HOME=str(isolated_home))
    processes = [
        subprocess.Popen(
