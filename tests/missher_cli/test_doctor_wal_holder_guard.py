"""Regression: ``missher doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on Missher *choosing* WAL mode (declined on vulnerable SQLite
