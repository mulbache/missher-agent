...
Run before any catalog commit:
    ...
    MISSHER_TEST_NETWORK=1 scripts/run_tests.sh tests/missher_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("MISSHER_TEST_NETWORK"),
    reason="network test; set MISSHER_TEST_NETWORK=1 to run",
)
