"""Tests for the specifier module + `missher kanban specify` CLI surface.
...
from missher_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `missher kanban …` argparse surface directly."""
