"""Tests for ``missher approvals suggest`` (missher_cli/approvals_suggest.py).

Approval history in Missher is implied, not ledgered: the session DB
...
from missher_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
