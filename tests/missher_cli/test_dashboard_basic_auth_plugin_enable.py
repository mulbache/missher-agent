...
from missher_cli.dashboard_auth import clear_providers, list_providers
from missher_cli.plugins import PluginManager, discover_plugins
...
class TestBasicProviderLoadsAfterUnblock:
    def test_disabled_basic_blocks_registration(self, missher_home, monkeypatch):
    ...
    def test_unblock_then_rediscover_registers_provider(
        ...
        _write_config(missher_home, cfg)
