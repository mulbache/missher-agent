"""Tests for Blank Slate setup mode (missher_cli/setup.py).
...
from missher_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
