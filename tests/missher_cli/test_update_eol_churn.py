"""Regression: ``missher update`` should take a managed checkout off autocrlf=true.
...
``missher update`` has to repair them.
...
from missher_cli.update_cmd import _normalize_managed_eol
