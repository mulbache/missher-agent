...
def test_monitor_shortcuts_preserve_draft_and_respect_modal_prompts(monkeypatch):
    ...
    from missher_cli import cli_subagent_monitor as monitor
    ...
    monkeypatch.setenv('MISSHER_DEFER_AGENT_STARTUP', '1')
    cli = MissherCLI(model='fixture', provider='openai-compat', api_key='fixture',
