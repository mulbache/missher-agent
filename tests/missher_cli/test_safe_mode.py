"""Tests for `missher chat --safe-mode` isolation."""
...
_VARS = ("MISSHER_SAFE_MODE", "MISSHER_IGNORE_USER_CONFIG", "MISSHER_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["MISSHER_SAFE_MODE"] == "1"
        assert os.environ["MISSHER_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["MISSHER_IGNORE_RULES"] == "1"
        return True
