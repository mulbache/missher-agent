"""Catalog-aware ``missher plugins`` surface (missher_cli/plugins_cmd_catalog.py): a bare catalog name installs
...
from missher_cli import plugins_cmd_catalog as cat
