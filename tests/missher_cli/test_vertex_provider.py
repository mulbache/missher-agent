...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (missher_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_missher_overlays():
    """missher_cli.providers.get_provider("vertex") backs
