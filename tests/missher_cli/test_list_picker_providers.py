...
import missher_cli.model_switch_providers as missher_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(missher_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("missher_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import missher_cli.models as hm
    import missher_cli.models_catalog_static as missher_cli_models_catalog_static
    from missher_cli import models_catalog_static
    ...
    monkeypatch.setattr(missher_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
