...
Profile-aware location: ``$MISSHER_HOME/logs/dashboard-auth.log``.
...
from missher_cli.dashboard_auth.audit import audit_log, AuditEvent


@pytest.fixture
def profile_home(tmp_path, monkeypatch):
    """Redirect $MISSHER_HOME and ~ to a tmp dir for the duration of the test."""
