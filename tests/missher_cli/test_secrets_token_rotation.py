"""Tests for `missher secrets bitwarden token` / `missher secrets onepassword token`.
...
from missher_cli import onepassword_secrets_cli as op_cli
from missher_cli import secrets_cli as bw_cli
