...
Every surface renders through ``missher_cli.status_report.build_status_fields``; each keeps
...
def test_three_status_surfaces_report_the_same_common_fields():
    with patch("missher_constants.display_missher_home", return_value=HOME), \
