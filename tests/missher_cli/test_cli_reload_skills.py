"""Tests for the ``/reload-skills`` CLI slash command (``MissherCLI._reload_skills``).
...
def _make_cli():
    """Build a minimal MissherCLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.MissherCLI)
