...
The oneshot path builds its AIAgent directly (bypassing MissherCLI), so the
...
from missher_cli.oneshot import _build_preloaded_skills_prompt, _normalize_skills
