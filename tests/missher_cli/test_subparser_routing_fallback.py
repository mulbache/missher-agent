...
The main() function in missher_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `missher -c model`
...
def _build_parser():
    """Build a minimal replica of the missher top-level parser."""
