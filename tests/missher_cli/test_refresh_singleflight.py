...
from missher_cli.dashboard_auth import refresh_singleflight as replay
from missher_cli.dashboard_auth.base import ProviderError, RefreshExpiredError, Session
from missher_cli.dashboard_auth.routes import router
...
def test_cookie_gate_burst_with_stale_rt_rotates_once(gated_web_app):
    ...
    cookies = {"missher_session_at": "expired-at", "missher_session_rt": "stale-rt",
               "missher_session_provider": "stub"}
