"""Tests for the ``missher prompt-size`` diagnostic (issue #34667)."""
...
from missher_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(missher_home, memory_text="", user_text=""):
    mem_dir = missher_home / "memories"
...
def _seed_skill(missher_home, name, description):
    skill_dir = missher_home / "skills" / "demo" / name
