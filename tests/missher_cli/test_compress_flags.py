...
Covers the pure helpers in ``missher_cli.partial_compress`` plus alias
...
from missher_cli.commands import COMMANDS, resolve_command
from missher_cli.partial_compress import (
    DEFAULT_KEEP_LAST,
