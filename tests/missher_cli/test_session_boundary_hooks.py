...
from missher_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/missher_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("missher_cli.lifecycle.invoke_hook")
@patch("missher_cli.lifecycle.finalize_session")
