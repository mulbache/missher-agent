"""Regression test: missher update must not load cryptography eagerly."""
...
assert 'missher_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running missher update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so missher_cli is importable,
