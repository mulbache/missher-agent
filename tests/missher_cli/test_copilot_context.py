...
class TestGetCopilotModelContext:
    ...
    @patch("missher_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("missher_cli.models._urlopen_model_catalog_request")
    ...
    @patch("missher_cli.models.fetch_github_model_catalog", return_value=[])
