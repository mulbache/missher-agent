...
class TestSummarizeToolResultClarify:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            # missher_cli/oneshot.py no-user callback
    ...
    def test_live_oneshot_producer_is_recognized_as_sentinel(self):
        ...
        from missher_cli.oneshot import _oneshot_clarify_callback
...
class TestAuthFailureAborts:
    ...
    def test_missing_provider_api_key_preserves_original_messages(self):
        ...
        err = RuntimeError(
            ...
            "to a different provider with missher model."
        )
        with patch(
...
class TestTruncateToolCallArgsJson:
    ...
    def test_shrunken_args_remain_valid_json(self):
        ...
        original = _json.dumps({
            "path": "~/.missher/skills/shopping/browser-setup-notes.md",
        ...
        assert parsed["path"] == "~/.missher/skills/shopping/browser-setup-notes.md"
