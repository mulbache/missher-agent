...
thinking phase.  Missher's default cloud-stream stale detector
(``MISSHER_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``MISSHER_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
