...
def make_missher_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated MISSHER_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"missher-home-{journal_mode}"
