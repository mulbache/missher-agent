...
def test_import_loads_env_from_missher_home(tmp_path, monkeypatch):
    home = tmp_path / ".missher"
    home.mkdir()
    (home / ".env").write_text("OPENROUTER_API_KEY=from-missher-home\n", encoding="utf-8")
    ...
    assert os.getenv("OPENROUTER_API_KEY") == "from-missher-home"
