...
The unit tests in tests/missher_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned missher-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/missher")
from missher_cli.service_manager import S6ServiceManager
