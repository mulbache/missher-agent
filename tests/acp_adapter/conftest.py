...
Keeps the ACP server tests offline: ``MissherACPAgent._build_model_state``
calls ``missher_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import missher_cli.inventory as inventory
