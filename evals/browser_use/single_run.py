...
The run gets a throwaway MISSHER_HOME so no local config leaks in, and the
...
if _or_key:
    ...
    # Resolved by the orchestrator BEFORE MISSHER_HOME is redirected to the
