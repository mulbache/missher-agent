...
os.environ["MISSHER_HOME"] = str(root / ".missher")
from missher_cli import update_cmd_fleet as fleet, update_receipt as receipts
...
try:
    for name in ["alpha", "beta"]:
        home = root / ".missher" / "profiles" / name
        ...
        p = subprocess.Popen(
            ...
            cwd=repo,
            env={**os.environ, "MISSHER_HOME": str(home)},
    ...
    d = root / ".missher/logs/update_receipts"
    ...
    home = root / ".missher/profiles/beta"
