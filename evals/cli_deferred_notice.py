...
def run_case(root, output, name, behind, early=False, cancel=False):
    with tempfile.TemporaryDirectory(prefix="missher_test_notice_") as home:
        ...
        from missher_cli.banner import VERSION
        ...
        bootstrap = ("import missher_cli.main as m; import missher_cli.banner as b; "
        ...
        try:
            ...
            result = {"case": name, "ready": ready, "exited": exited,
                      ...
                      "loaded_worktree": str(root / "missher_cli/banner.py") in text,
