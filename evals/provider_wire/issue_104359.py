...
home = tempfile.mkdtemp(prefix="missher-104359-")
os.environ.clear()
os.environ.update(
    HOME=home,
...
Path(os.environ["MISSHER_HOME"], "config.yaml").write_text(yaml.safe_dump(config), encoding="utf-8")
...
db = SessionDB(Path(os.environ["MISSHER_HOME"]) / "state.db")
