...
benchmarked ten harnesses on hostile-file handling — and whose Missher column
...
Every task runs the full Missher agent (file + terminal + search toolsets)
...
Rules of engagement (from missherbench discipline):
