...
os.environ['MISSHER_NIX_BUILD'] = '1'
sys.path.insert(0, str(root))
commands = importlib.import_module("missher_cli.cli_commands_mixin")
GoalManager = importlib.import_module("missher_cli.goals").GoalManager
