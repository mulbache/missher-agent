...
os.environ["MISSHER_HOME"] = tempfile.mkdtemp(prefix="missher-e2e-55712-")
for m in [k for k in sys.modules if k.startswith(("missher", "tools", "plugins"))]:
    del sys.modules[m]

import uvicorn  # noqa: E402

from missher_cli import web_server  # noqa: E402
from missher_cli.dashboard_auth import register_provider  # noqa: E402
from missher_cli.dashboard_auth.base import RefreshExpiredError, Session  # noqa: E402
from tests.missher_cli.conftest_dashboard_auth import StubAuthProvider  # noqa: E402
...
idp.calls = 0
ck = "missher_session_at=expired-at; missher_session_rt=cookie-stale; missher_session_provider=stub"
with ThreadPoolExecutor(4) as pool:
