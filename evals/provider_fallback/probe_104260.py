...
sandbox = tempfile.TemporaryDirectory(prefix="missher-104260-")
os.environ.clear()
os.environ.update(
    HOME=sandbox.name,
    MISSHER_HOME=sandbox.name + "/missher",
    PATH="/usr/bin:/bin",
    PYTHONDONTWRITEBYTECODE="1",
    MISSHER_DISABLE_MODEL_METADATA_FETCH="1",
)
...
# JSON is valid YAML; only the temporary Missher home is written.
