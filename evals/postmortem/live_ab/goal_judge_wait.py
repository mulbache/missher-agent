...
os.environ.setdefault("MISSHER_HOME", os.path.expanduser("~/.missher"))  # LIVE: real auxiliary judge calls (cents)
from missher_cli import goals
goal = ("Simplify the missher-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
