...
# Remove all inherited Missher/config and credential env before real imports.
...
os.environ['MISSHER_HOME'] = home.name
os.environ['NO_PROXY'] = '*'
os.environ['TZ'] = 'UTC'
...
from missher_cli import cli_commands_mixin, goals
...
server._missher_home = Path(home.name)
...
with patch('missher_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
