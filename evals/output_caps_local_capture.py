...
Run from a checkout with MISSHER_HOME pointing to a disposable directory.
"""
import json
import os
...
os.environ["MISSHER_MAX_TOKENS"] = "13"
...
from missher_cli.moa_config import _normalize_preset
