"""Live E2E: vault fill through the REAL browser_exec path (Browser Use CLI + Missher' packaged Chromium).
...
Run: MISSHER_E2E_BROWSER=1 <venv>/bin/python evals/vault_fill_live_e2e.py
"""
...
HOME = Path(tempfile.mkdtemp(prefix="missher-vault-e2e-"))
