...
_SESSION_CWD: ContextVar = ContextVar("MISSHER_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Missher source tree, a
    legitimate workspace when developing Missher; fallback-directory policy lives in the caller."""
