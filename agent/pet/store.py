...
Pets live under ``get_missher_home()/pets/<slug>/`` (profile-scoped; NOT petdex's
...
_HTTP_HEADERS = {"User-Agent": "missher-agent-petdex"}
_THUMB_FRAME_W = 192
_THUMB_FRAME_H = 208
...
def pets_dir() -> Path:
    ...
    return _ensure_dir(get_missher_home() / "pets")
