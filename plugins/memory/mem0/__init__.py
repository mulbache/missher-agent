...
self-hosted Mem0 server (MEM0_HOST, HTTP), or OSS Memory. Secrets live in $MISSHER_HOME/.env
(MEM0_API_KEY, MEM0_HOST); settings in $MISSHER_HOME/mem0.json via `missher memory setup`:
...
def _load_config() -> dict:
    """Env vars provide defaults; $MISSHER_HOME/mem0.json overrides individual keys.
    ...
    config = {"mode": get_secret("MEM0_MODE", "") or "platform", "host": get_secret("MEM0_HOST", "") or "",
              "agent_id": get_secret("MEM0_AGENT_ID", "") or "missher", "oss": {}}
    ...
    file_cfg = read_json_or_empty(get_missher_home() / "mem0.json")
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._mode, self._api_key, self._host, self._user_id, self._agent_id = "platform", "", "", _DEFAULT_USER_ID, "missher"
    ...
    def save_config(self, values, missher_home):
        """Merge-write config to $MISSHER_HOME/mem0.json."""
        config_path = Path(missher_home) / "mem0.json"
    ...
    def get_config_schema(self):
        ...
        return [
            ...
            {"key": "user_id", "description": "User identifier", "default": "missher-user"},
            {"key": "agent_id", "description": "Agent identifier", "default": "missher"},
            {"key": "rerank", "description": "Enable reranking for recall", "default": "false", "choices": ["true", "false"]},
        ]

    def post_setup(self, missher_home: str, config: dict) -> None:
        from ._setup import post_setup
        post_setup(missher_home, config)
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        self._mode, self._api_key, self._host, self._agent_id = cfg.get("mode", "platform"), cfg.get("api_key", ""), cfg.get("host", ""), cfg.get("agent_id", "missher")
