/**
 * Missher desktop plugin template. Save as:
 *   <missher home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <missher home> is ~/.missher by default, or ~/.missher/profiles/<name>
 * when running a named profile (`missher -p <name>`). Run `missher doctor` (or
 ...
 * Only these imports resolve: @missher/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@missher/plugin-sdk'
