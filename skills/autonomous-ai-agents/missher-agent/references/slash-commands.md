...
Registry of record: `missher_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore Missher config+state snapshots (CLI)
...
/update                  Update Missher to latest
