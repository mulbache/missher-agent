...
Built for [Missher Agent](https://github.com/NousResearch/missher-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/missher-agent/skills/creative/ascii-video`](https://github.com/NousResearch/missher-agent/tree/main/skills/creative/ascii-video) via PR.
