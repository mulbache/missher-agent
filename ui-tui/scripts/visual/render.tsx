 ...
 * across theme x background scenes to <tmpdir>/missher-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@missher/ink'
...
// The regenerated slate light_colors block from missher_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/missher-agent',
...
const setup = (bgHex: string) => {
  process.env.MISSHER_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
