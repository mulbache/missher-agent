...
await build({
  ...
  // Skip the prebuilt @missher/ink bundle and inline the source instead:
  ...
  alias: { '@missher/ink': resolve(root, 'packages/missher-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The missher_cli launcher
