...
import type { ScrollBoxHandle } from '@missher/ink'
import { evictInkCaches } from '@missher/ink'
import type { InflightTurn, SessionResumeResult, Usage } from '@missher/shared/gateway-events'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.MISSHER_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
