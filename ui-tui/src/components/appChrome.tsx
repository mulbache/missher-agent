import { Box, type ScrollBoxHandle, stringWidth, Text } from '@missher/ink'
import { compactNumber } from '@missher/shared/format'
import type { Usage } from '@missher/shared/gateway-events'
...
export function StatusRule({
  ...
  // Dev-only readout (MISSHER_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (MISSHER_DEV_CREDITS), lowest priority,
