 ...
 *
 * Symptom: in `missher --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@missher/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using missher --tui and as i type multiline my caret at the end will often ' +
