...
def main() -> None:
    ...
    missher_home = Path(tempfile.mkdtemp(prefix="missher-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "missher-gateway-smoke",
    ...
    print(json.dumps({"missher_home": str(missher_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
