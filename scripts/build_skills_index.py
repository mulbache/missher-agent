#!/usr/bin/env python3
"""Build the Missher Skills Index — a centralized JSON catalog of all skills.
...
`missher skills search/install` can use it without hitting the GitHub API.
...
# Ensure MISSHER_HOME is set (needed by tools/skills_hub*.py imports)
...
def main():
    print("Building Missher Skills Index...", flush=True)
