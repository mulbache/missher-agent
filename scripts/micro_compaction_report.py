#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from Missher logs.
...
With no LOGFILE, reads ``$MISSHER_HOME/logs/agent.log`` (default ~/.missher).
...
def default_log() -> Path:
    home = os.environ.get("MISSHER_HOME") or str(Path.home() / ".missher")
