#!/usr/bin/env python3
"""Build the Missher Model Catalog — a centralized JSON manifest of curated models.
...
Missher CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Missher release.
...
# Ensure MISSHER_HOME is set for imports that touch it at module level.
os.environ.setdefault("MISSHER_HOME", os.path.join(os.path.expanduser("~"), ".missher"))

from missher_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "missher-agent repo",
            "docs": "https://missher-agent.nousresearch.com/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model Missher '
