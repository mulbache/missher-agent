...
# Contributor attribution data was removed from this fork
# (see contributors/README.md). The map stays empty; resolve_author()
# falls back to noreply-login parsing, then the git author name.
LEGACY_AUTHOR_MAP = {
}
...
def _load_contributor_dir(directory: "Path | None" = None) -> dict:
    """Load one-file-per-email mappings (removed from this fork: always {})."""
