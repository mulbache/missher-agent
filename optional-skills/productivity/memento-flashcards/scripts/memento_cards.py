...
Data file: $MISSHER_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MISSHER_HOME = Path(os.environ.get("MISSHER_HOME", Path.home() / ".missher"))
DATA_DIR = _MISSHER_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
