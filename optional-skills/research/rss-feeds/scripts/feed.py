...
Standard library only, so it runs in any Missher environment without an install
...
USER_AGENT = "missher-agent/1.0 (rss-feeds skill; +https://github.com/NousResearch/missher-agent)"
TIMEOUT = 20
NS = {
