...
def _state_dir() -> Path:
    ...
    # Default: $MISSHER_HOME/watcher-state/, falling back to ~/.missher/watcher-state/.
    missher_home = os.environ.get("MISSHER_HOME") or str(Path.home() / ".missher")
    return Path(missher_home) / "watcher-state"
