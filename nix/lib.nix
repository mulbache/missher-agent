      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via MISSHER_BUNDLED_SKILLS /
            # MISSHER_OPTIONAL_SKILLS (see missher-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + MISSHER_BUNDLED_LOCALES
            # / MISSHER_OPTIONAL_MCPS, not via the wheel. Excluding them
