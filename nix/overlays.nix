# nix/overlays.nix — Expose pkgs.missher-agent for external NixOS configs
#
...
# `pkgs.missher-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    missher-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
