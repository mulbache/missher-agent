"""Non-interactive HTTPS credentials for Missher's internal git clones (private plugin/MCP/profile repos).
...
repo the user can already clone from their shell fails inside ``missher plugins install`` with
