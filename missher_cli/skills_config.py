"""Skills configuration for Missher Agent. `missher skills` enters this module."""
from typing import List, Optional, Set

from missher_cli.config import cfg_get, load_config, save_config
from missher_cli.colors import Colors, color
from missher_cli.platforms import PLATFORMS as _PLATFORMS
...
def save_disabled_skills(config: dict, disabled: Set[str], platform: Optional[str] = None):
    """Persist disabled skill names to config; essential skills (e.g. ``missher-agent``) are
...
def skills_command(args=None):
    """Entry point for `missher skills`."""
    from missher_cli.curses_ui import curses_checklist
    config = load_config()
