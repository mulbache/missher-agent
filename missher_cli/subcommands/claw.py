"""``missher claw`` subcommand parser."""
...
def build_claw_parser(subparsers, *, cmd_claw: Callable) -> None:
    ...
    claw_parser = subparsers.add_parser(
        ...
        description="Migrate settings, memories, skills, and API keys from OpenClaw to Missher")
    claw_subparsers = claw_parser.add_subparsers(dest="claw_action")

    # claw migrate
    claw_migrate = claw_subparsers.add_parser(
        "migrate", help="Migrate from OpenClaw to Missher",
    ...
    claw_migrate.add_argument(
        ...
        help="Skip the pre-migration zip snapshot of ~/.missher/ (by default a "
        "single restore-point archive is written to ~/.missher/backups/ "
        "before apply; restorable with 'missher import').")
    claw_migrate.add_argument(
