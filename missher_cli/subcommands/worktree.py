"""``missher worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory missher -w sessions "
            "accumulate. Never deletes uncommitted tracked changes, unique "
            "unpushed commits, or in-use trees; untracked-only scratch is "
            "archived to ~/.missher/archive/worktree-prune/ before removal. See: "
            "https://missher-agent.nousresearch.com/docs/user-guide/cli#worktree-cleanup")
