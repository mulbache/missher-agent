...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Missher Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any missher CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--missher-root",
        help="Override the Missher source root used by Desktop (sets MISSHER_DESKTOP_MISSHER_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets MISSHER_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Missher Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Missher Local Signing)",
    )
