"""Client for uploading ``missher debug share`` bundles to Nous-internal S3.
...
NAS_BASE = os.environ.get("MISSHER_DIAGNOSTICS_BASE_URL", "https://portal.nousresearch.com")
_REQUEST_TIMEOUT = 30
