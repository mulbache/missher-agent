"""Missher skin/theme engine — the theme SDK for every surface."""
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces MISSHER_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces MISSHER_CADUCEUS)
...
# Branding shared by every Missher-named built-in (mono/daylight override help_header).
_MISSHER_BRANDING: Dict[str, str] = _branding(
    "Missher", "☤", "Goodbye! ☤", prompt="❯", help_header="(^_^)? Available Commands")

_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default", "description": "Classic Missher — gold and kawaii",
...
[dim #6B1717]⠀⠀⠀⠀⠀⠀⠀⠀war god online⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "mono": {
        ...
        "spinner": {},
        "branding": {**_MISSHER_BRANDING, "help_header": "[?] Available Commands"},
        "tool_prefix": "┊"},
    "slate": {
        ...
        "spinner": {}, "branding": _MISSHER_BRANDING, "tool_prefix": "┊"},
    "daylight": {
        "name": "daylight",
...
def _routed_home_key() -> Optional[str]:
    ...
    return None if get_missher_home_override() is None else missher_home_key()
