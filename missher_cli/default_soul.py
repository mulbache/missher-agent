"""Default SOUL.md template seeded into MISSHER_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Missher Agent, built by Nous Research. Be direct: match the length of your reply to the weight of "
...
_SCAFFOLD_HEAD = (
    "# Missher Agent Persona\n\n<!--\nThis file defines the agent's personality and tone.\n"
    "The agent will embody whatever you write here.\nEdit this to customize how Missher communicates with you.\n\n"
)
_SCAFFOLD_TAIL = (
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Missher Agent, an intelligent AI assistant created by Nous Research. You are helpful, "
