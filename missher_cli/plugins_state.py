"""Plugin-owned durable state and namespaced settings helpers (split out of missher_cli.plugins)."""
...
from missher_cli.plugins_manifest import _portable_skill_namespace
...
class PluginState:
    ...
    def data_dir(self) -> Path:
        ...
        return get_missher_home() / "plugin-data" / self._data_namespace
