...
from missher_cli.anon_sign_in import Code, SignInState, UPGRADE_CANCELLED, UPGRADE_START
...
def render_sign_in_cli_code(
    ...
    from missher_cli.auth_device_flow import _print_device_code_instructions
...
def upgrade_guest(args) -> int:
    """``missher auth upgrade``: sign in with a Nous account, transferring the free tier's connectors.
    ...
    """
    from missher_cli import anon_auth as _core
    from missher_cli.auth_device_flow import _is_remote_session
