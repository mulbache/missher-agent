"""Relay subscriber for the persisted Missher shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Missher counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Missher shared metric: %s", metric_name, exc_info=True
                )
