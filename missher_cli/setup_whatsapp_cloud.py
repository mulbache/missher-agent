...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Missher to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Missher needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Missher gateway in another terminal:",
        "         missher gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://missher-agent.nousresearch.com/docs/user-guide/",
