...
def _foreign_list(rid, params):
    from missher_cli.foreign_sessions_browser import list_foreign_sessions
    try:
...
def _foreign_history_request(rid, params, importing):
    from missher_cli.foreign_sessions_browser import import_browser_session, preview_foreign_session
    try:
