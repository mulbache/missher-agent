...
# containing `cat ~/.missher/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `missher-agent-dev` skill contains a security postmortem mentioning `cat ~/.missher/.env`, which tripped
