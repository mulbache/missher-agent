...
Used by missher_cli/skills_hub.py for CLI commands and the /skills slash command.
"""
...
_skills_dir = _path_resolver("SKILLS_DIR", "MISSHER_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"MISSHER_HOME": _missher_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'MISSHER_INDEX_TTL': ('tools.skills_hub_search', 'MISSHER_INDEX_TTL'),
    'MISSHER_INDEX_URL': ('tools.skills_hub_search', 'MISSHER_INDEX_URL'),
    'MissherIndexSource': ('tools.skills_hub_official', 'MissherIndexSource'),
