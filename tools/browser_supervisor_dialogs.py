...
DIALOG_BRIDGE_HOST = "missher-dialog-bridge.invalid"
...
(() => {
  if (window.__missherDialogBridgeInstalled) return;
  window.__missherDialogBridgeInstalled = true;
  const ENDPOINT = "http://missher-dialog-bridge.invalid/";
