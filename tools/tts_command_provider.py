...
def render_command_template(command_template: str, placeholders: Dict[str, str]) -> str:
    ...
    def replace_match(match: re.Match[str]) -> str:
        ...
        token = f"__MISSHER_CMD_PLACEHOLDER_{len(replacements)}__"
...
def run_command_provider(
    ...
    provider survives, a silently stalled one is killed. Child env is scrubbed of Missher secrets
    ...
    scrubbed = missher_subprocess_env(inherit_credentials=False)
