...
worktree per child under ``<repo>/.worktrees/subagent-<id>``, branch ``missher-subagent/<id>``;
...
from missher_cli._subprocess_compat import harden_git_argv, noninteractive_git_env
...
def create_subagent_worktree(parent_cwd: Optional[str], subagent_id: Optional[str] = None) -> Optional[Dict[str, str]]:
    ...
    branch = f"missher-subagent/{wt_name}"
