...
LOCAL_STT_COMMAND_ENV = "MISSHER_LOCAL_STT_COMMAND"
LOCAL_STT_LANGUAGE_ENV = "MISSHER_LOCAL_STT_LANGUAGE"
...
# DeepInfra STT base URL is resolved via missher_cli.models.deepinfra_base_url (shared).
