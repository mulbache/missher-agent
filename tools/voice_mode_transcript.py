...
# is treated as a self-capture of Missher' own TTS: the full-duplex listener has no echo
...
def is_tts_echo(transcript: str, spoken_text: str,
    ...
    (language-agnostic): a genuine interjection rarely matches Missher' own words, so a high ratio signals
