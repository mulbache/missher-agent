"""Close a read-only agent terminal tab in the Missher desktop GUI WITHOUT killing
...
CLOSE_TERMINAL_SCHEMA = {
    ...
    "description": (
        ...
        "the Missher desktop GUI (the tabs mirroring terminal(background=true) runs). "
