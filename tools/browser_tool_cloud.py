...
def _memo(_bt, resolved_attr: str, cache_attr: str, compute: Callable[[], object]):
    ...
    Under a routed profile (MISSHER_HOME override, multiplexed gateway) the slot is NOT consulted: every
...
def _get_cloud_provider() -> Optional[CloudBrowserProvider]:
    """Return the provider cached for the active Missher profile."""
    _bt = _origin()
