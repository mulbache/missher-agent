...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `missher_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `missher_cli/` | [Extending the CLI](extending-the-cli.md) |
| Plugins system | `plugins/` | [Build a Missher Plugin](plugins/index.md) |
...
| Session storage | `missher_state.py`, `missher_state_*.py` | [Session Storage](session-storage.md) |
