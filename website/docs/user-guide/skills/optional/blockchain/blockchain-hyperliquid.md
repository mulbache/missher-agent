...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain\hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Missher Agent |
| License | MIT |
...
The script reads `${MISSHER_HOME:-~/.missher}/.env` for two optional defaults:
...
Helper script: `~/.missher/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.missher/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${MISSHER_HOME:-~/.missher}/.env`.
...
```bash
python ~/.missher/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.missher/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
