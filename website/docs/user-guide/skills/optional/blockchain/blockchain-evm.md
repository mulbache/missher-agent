...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain\evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Missher Agent |
| License | MIT |
...
Helper script path: `~/.missher/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.missher/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.missher/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.missher/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
