...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/smart-home/openhue` |
...
- Bridge must be on the same local network as the machine running Missher
