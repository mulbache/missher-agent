...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/web-development/page-agent` |
...
- User wants **Missher itself to drive a browser** → use Missher' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
