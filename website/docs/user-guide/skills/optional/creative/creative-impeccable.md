...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/creative/impeccable` |
...
> ships and verifies a Missher-native skill bundle under `.missher/skills/`.
> `missher skills install impeccable` pulls the current bundle live from that
