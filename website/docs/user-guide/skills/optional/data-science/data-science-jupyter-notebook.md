...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/data-science/jupyter-notebook` |
...
| `execute_code` | One-shot scripts needing missher tool access (web_search, file ops). Stateless. |
