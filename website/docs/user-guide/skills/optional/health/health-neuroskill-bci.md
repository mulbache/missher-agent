...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/health/neuroskill-bci` |
...
Connect Missher to a running [NeuroSkill](https://neuroskill.com/) instance to read
