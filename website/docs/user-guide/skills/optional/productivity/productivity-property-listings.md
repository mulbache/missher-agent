...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Missher desktop transcript.
...
- A Missher desktop conversation for native cards; the backend may be local or remote.
...
```text
missher skills install official/productivity/property-listings
```
