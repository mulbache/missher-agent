...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/productivity/shopify` |
...
4. Save to `${MISSHER_HOME:-~/.missher}/.env`:
   ```
...
}' '{"input":{"title":"Test Hoodie","status":"DRAFT","vendor":"Missher","productType":"Apparel","tags":["test"]}}'
```
