...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/research/rss-feeds` |
...
`python3 scripts/feed.py read https://github.com/NousResearch/missher-agent/releases.atom
