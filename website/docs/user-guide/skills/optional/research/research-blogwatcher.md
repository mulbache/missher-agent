...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/research/blogwatcher` |
...
## Working with Missher tools (read this first)

`blogwatcher-cli` is the feed database; Missher tools do the automation around it:
