...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/research/qmd` |
...
| Related skills | [`obsidian`](/docs/user-guide/skills/bundled/note-taking/note-taking-obsidian), [`missher-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-missher-agent), [`arxiv`](/docs/user-guide/skills/bundled/research/research-arxiv) |
...
Missher Agent via the native MCP client. This is the preferred
...
Then configure Missher Agent to connect via HTTP:
