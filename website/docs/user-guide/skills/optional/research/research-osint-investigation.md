...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/research/osint-investigation` |
| Path | `optional-skills/research\osint-investigation` |
| Version | `0.1.0` |
| Author | Missher Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
| License | MIT |
...
# $MISSHER_OSINT_CACHE/icij/ (default: ~/.cache/missher-osint/icij/).
...
# Set MISSHER_OSINT_UA=your-app/1.0 (your@email) to identify yourself
