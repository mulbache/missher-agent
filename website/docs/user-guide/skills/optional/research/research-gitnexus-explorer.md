...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/research/gitnexus-explorer` |
...
| Related skills | [`missher-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-missher-agent), [`codebase-inspection`](/docs/user-guide/skills/bundled/software-development/software-development-codebase-inspection) |
...
- **The web UI does NOT create `.claude/` or `CLAUDE.md`.** Those are created by
  ...
  missher-agent users don't need.
