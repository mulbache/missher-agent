...
| | |
|---|---|
| Source | Optional — install with `missher skills install official/finance/stocks` |
| Path | `optional-skills/finance\stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Missher Agent |
| License | MIT |
...
```
SCRIPT=~/.missher/skills/finance/stocks/scripts/stocks_client.py
...
```
python ~/.missher/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
