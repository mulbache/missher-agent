...
Script path: `~/.missher/skills/maps/scripts/maps_client.py`

## Commands

```bash
MAPS=~/.missher/skills/maps/scripts/maps_client.py
```
...
```bash
python ~/.missher/skills/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python ~/.missher/skills/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
