...
| [`missher-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-missher-agent) | Use, configure, theme, extend, and orchestrate Missher Agent. | `autonomous-ai-agents\missher-agent` |
...
| [`missher-agent-skill-authoring`](/docs/user-guide/skills/bundled/software-development/software-development-missher-agent-skill-authoring) | Author in-repo SKILL.md files: frontmatter and structure. | `software-development\missher-agent-skill-authoring` |
| [`inspecting-missher-desktop-dom`](/docs/user-guide/skills/bundled/software-development/software-development-inspecting-missher-desktop-dom) | Read the live Missher desktop DOM/CSS over CDP. | `software-development\inspecting-missher-desktop-dom` |
