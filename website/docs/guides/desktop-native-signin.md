...
description: "How the Missher Desktop app signs in to a gated gateway using your system browser and PKCE — no embedded webview, no session cookies"
---

# Desktop Native Sign-In (RFC 8252)

When the Missher Desktop app connects to a **gated gateway** (a hosted or
...
For Missher specifically, native sign-in means:
...
- [Run Missher with Nous Portal](./run-missher-with-nous-portal.md)
