#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Missher docs site.
...
LLM reads to learn what Missher does.

Both publish at:
  https://missher-agent.nousresearch.com/docs/llms.txt
  https://missher-agent.nousresearch.com/docs/llms-full.txt
...
SITE_BASE = "https://missher-agent.nousresearch.com/docs"
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Guides & Tutorials", [
        ...
        ("guides/python-library", "Use Missher as a Python Library", None),
        ("guides/use-mcp-with-missher", "Use MCP with Missher", None),
        ("guides/use-voice-mode-with-missher", "Use Voice Mode with Missher", None),
        ("guides/use-soul-with-missher", "Use SOUL.md with Missher", None),
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Missher"),
...
def emit_llms_index() -> str:
    ...
    lines.append(
        ...
        "missher-agent/main/scripts/install.sh | bash`  "
        "(Linux, macOS, WSL2, Termux)"
    )
    lines.append("")
    lines.append("Repo: https://github.com/NousResearch/missher-agent")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Missher Agent — Full Documentation\n",
        (
            "This file is the entire Missher Agent documentation concatenated for LLM "
            "context ingestion. Section order reflects docs-site navigation: Getting "
            "Started, Using Missher, Features, Messaging, Integrations, Guides, "
            "Developer Guide, Reference, then everything else.\n"
        ),
        "Canonical site: https://missher-agent.nousresearch.com/docs\n",
        "Short index: https://missher-agent.nousresearch.com/docs/llms.txt\n",
        "\n---\n\n",
    ]
