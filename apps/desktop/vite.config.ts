...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\missher\missher-agent\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@missher/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@missher/shared/billing': path.resolve(__dirname, '../shared/src/billing-types.ts'),
      '@missher/shared/color': path.resolve(__dirname, '../shared/src/color.ts'),
      '@missher/shared': path.resolve(__dirname, '../shared/src'),
