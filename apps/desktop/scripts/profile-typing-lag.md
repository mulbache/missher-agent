...
cd apps/desktop
XCURSOR_SIZE=24 MISSHER_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/missher-typing
# → /tmp/missher-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/missher-typing.before.heapsnapshot
# → /tmp/missher-typing.after.heapsnapshot
```
