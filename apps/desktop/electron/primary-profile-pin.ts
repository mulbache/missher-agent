 ...
 *     it via `missher:profile:remember` without re-homing the primary.
 ...
 * the same MISSHER_HOME. That duplicate held a pool slot and starved every other
...
export class PrimaryProfilePin {
  ...
  /** Called by startMissher() with the profile the primary is launching as. */
