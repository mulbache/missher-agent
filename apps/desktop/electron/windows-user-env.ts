...
// even though a fresh shell — and the Missher CLI — sees it immediately. The
// desktop's MISSHER_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\missher. Reading
...
//       MISSHER_HOME    REG_SZ    F:\Missher\data
//
