...
// reads MISSHER_GUEST_ONBOARDING and treats exactly "1" as on; the desktop
...
export const GUEST_ONBOARDING_ENV = 'MISSHER_GUEST_ONBOARDING'
...
// on every fresh MISSHER_HOME. Renderer-only; the backend never sees it.
export const SKIP_INTRO_ENV = 'MISSHER_SKIP_INTRO'
