...
const STORAGE_KEY = 'missher.desktop.layoutTree.v2'

writeKey('missher.desktop.layoutTree.v1', null)
 ...
 */
export const $activePresetId = atom<string>(readKey('missher.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('missher.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'missher.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'missher.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'missher.desktop.hiddenStripTabs.v1'
...
writeKey('missher.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__MISSHER_LAYOUT_TREE__ = {
    close: closeTreePane,
