import type { ModelOptionProvider, ModelPricing } from '@missher/shared'
import { fuzzyRank, modelSearchText } from '@missher/shared'
...
export function ModelPickerDialog({
  ...
  // it: an empty query shows the curated list verbatim (like the `missher
