...
const relaySource = readFileSync(join(process.cwd(), 'src/plugins/missher-bots/relay.ts'), 'utf8')
const repoRoot = join(process.cwd(), '..', '..')
const configDefaults = readFileSync(join(repoRoot, 'missher_cli/config_defaults.py'), 'utf8')
