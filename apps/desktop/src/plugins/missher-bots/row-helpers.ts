...
import { atom, host, useValue } from '@missher/plugin-sdk'
...
export function previewKind(preview: null | string | undefined): { fromBot: null | string } {
  ...
  if (match) {
    ...
    // profile reads @missher, never @default (#89484).
 ...
 *  (missher-agent#90268). Older gateways omit worker_session — always false. */
