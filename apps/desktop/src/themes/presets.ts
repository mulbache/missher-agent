...
import { THEME_PRESET_PALETTES } from '@missher/shared'
...
/**
 * Nous — the canonical Missher desktop identity, forked from the GitHub VS Code
 ...
 * extension yourself.
 *
 * Typography stays Missher's own: a VS Code theme carries no font opinion, and
...
/**
 * Nous — the canonical Missher desktop identity: GitHub's chrome carrying Nous
