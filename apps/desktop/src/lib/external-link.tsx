...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|missher):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.missherDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.missherDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Missher, and it is the surface the agent
