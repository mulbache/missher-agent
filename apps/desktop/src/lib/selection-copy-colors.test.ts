...
describe('installSelectionCopyColorGuard', () => {
  beforeEach(() => {
    document.documentElement.dataset.missherMode = 'dark'
  })

  afterEach(() => {
    delete document.documentElement.dataset.missherMode
    window.getSelection()?.removeAllRanges()
  })
  ...
  it('leaves light-ink selections alone when the theme is light', () => {
    document.documentElement.dataset.missherMode = 'light'
