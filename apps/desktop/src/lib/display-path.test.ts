...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/missher-agent')).toBe('~/www/missher-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/missher-agent')).toBe('missher-agent')
    expect(pathLeaf('~/www/missher-agent')).toBe('missher-agent')
