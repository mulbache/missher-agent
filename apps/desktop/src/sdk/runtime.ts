 ...
 * plugins resolve `@missher/plugin-sdk` through the vite alias; RUNTIME-loaded
...
// `sdk/runtime` — so a module-scope `{ __MISSHER_PLUGIN_SDK__: sdk, … }` is
...
// `Object.keys(GLOBALS.__MISSHER_PLUGIN_SDK__)` threw
...
function pluginNamespaces() {
  return {
    __MISSHER_PLUGIN_SDK__: sdk,
    __MISSHER_REACT__: React,
    __MISSHER_REACT_JSX__: jsxRuntime,
    __MISSHER_REACT_JSX_DEV__: jsxDevRuntime
  }
}
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@missher/plugin-sdk': shimUrl('__MISSHER_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__MISSHER_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__MISSHER_REACT_JSX__'),
    react: shimUrl('__MISSHER_REACT__')
  }
