...
export interface Translations {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshMissherPathTitle: string
      sshMissherPathDesc: string
      sshMissherPathPlaceholder: string
  ...
  commandCenter: {
    ...
    missherActiveSessions: (version: string, count: number) => string
