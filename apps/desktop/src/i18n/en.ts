...
export const en: Translations = {
  connectors: {
    ...
    disclaimer: 'Connecting is optional. Only authorize the apps you want Missher to use.',
    connectTitle: app => `Connect ${app}?`,
    describe: app => `Missher signs in to ${app} in your browser and asks before reading anything there.`,
    execution: 'Connector tools'
  },

  sessionImport: {
    title: 'Continue from another app',
    subtitle: 'Bring a conversation into Missher and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Missher.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Missher. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Missher',
    continue: 'Continue in Missher',
  ...
  boot: {
    ready: 'Missher Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Missher settings',
      loadingSessions: 'Loading recent sessions',
      retryingRemoteBackend: 'Reconnecting to the remote Missher backend…',
      startingDesktopConnection: 'Starting desktop connection',
      startingMissherDesktop: 'Starting Missher Desktop…'
    },
    errors: {
      backgroundExited: 'Missher background process exited.',
      backgroundExitedDuringStartup: 'Missher background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Missher backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateMissher: 'Update Missher',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Missher Desktop.',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Could not hand the request to Missher',
    ...
    native: {
      ...
      inputBody: 'Missher is waiting for your response.',
      turnDoneTitle: 'Missher finished',
      turnDoneBody: '',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'You can also run `missher debug share --nous` from a terminal, or `missher debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Missher defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Missher catalog entry "${name}" — the agent component installs at the reviewed pin${sha ? ` ${sha}` : ''}, not the branch tip.`,
    ...
    vault: {
      ...
      otpHint: 'The "setup key" the site shows when you enable 2FA. With it saved, Missher generates the codes itself.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `Not detected. Install the ${name} command-line tool and sign in to it; Missher picks it up automatically.`,
        disabledDesc: 'Detected but turned off for Missher.',
        lockedDesc: 'Detected. The agent will ask you to unlock it when it needs a login, or unlock now.',
        unlockedDesc: 'Unlocked for this session. Locks automatically after 30 minutes idle or when Missher closes.',
        statusLocked: 'Locked',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Missher is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Missher asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Missher was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Missher was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Missher follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Missher can react to yours.',
      tipsTitle: 'In-App Tips',
      tipsDesc:
        'Occasional hints from the app and Missher. Each tip appears once. Turns off automatically after your first 30 days; you can turn it back on.',
      tipsReset: (count: number) => `Show ${count} ${count === 1 ? 'tip' : 'tips'} again`,
      toursTitle: 'Guided Tours',
      toursDesc:
        'Let Missher spotlight each step as it guides you through the app. Turns off automatically after your first 30 days; you can turn it back on.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Missher is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Missher, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      uninstallMissher: 'Uninstall Missher'
    },
    poolLimits: {
    ...
    about: {
      heading: 'Missher Desktop',
      version: value => `Version ${value}`,
      versionUnavailable: 'Version unavailable',
      bundleOutOfSync: 'App build out of date',
      bundleOutOfSyncDesc:
        'The Missher runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      bundleOutOfSyncAction: 'Get the installer',
      bundleSwapPending: 'Restart to finish the update',
      bundleSwapPendingDesc:
        'The updated app is already installed — Missher only needs to restart to load it. Chats and settings are untouched.',
      bundleSwapPendingAction: 'Restart Missher',
      updates: 'Updates',
      checkNow: 'Check now',
      checking: 'Checking…',
      seeWhatsNew: "See what's new",
      ...
      automaticUpdatesDesc:
        'Missher checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Missher configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Missher.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Missher gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      updateSkippedCloud: 'Managed by Missher Cloud',
      kindLocal: 'Local',
      kindRemote: 'Remote gateway',
      kindCloud: 'Missher Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'The Missher runtime managed by this app.',
      kindRemoteDesc: 'A Missher gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Missher Cloud account.',
      kindSshDesc: 'A Missher install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Missher manages (Authorization, Cookie, Host…) are ignored.',
      ...
      cloudAddHint:
        'Tip: signing in under Missher Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Missher backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      envOverrideTitle: 'Environment variables are controlling this desktop session.',
      envOverrideDesc:
        'Unset MISSHER_DESKTOP_REMOTE_URL and MISSHER_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Missher backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote Missher backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'Missher Cloud',
      cloudDesc: 'Sign in once to Missher Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Missher Cloud',
      cloudSignIn: 'Sign in to Missher Cloud',
      cloudSignedIn: 'Signed in to Missher Cloud',
      cloudNeedsSignIn: 'Sign in to Missher Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Missher Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Missher Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Missher Cloud',
      cloudSignedOutMessage: 'Cleared the Missher Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /missher.',
      ...
      restartingMessage: 'Missher Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Missher ${version}` : ''}`,
      ...
      sshDesc:
        'Missher is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshMissherPathTitle: 'Missher path (optional)',
      sshMissherPathDesc: 'Full path to the remote missher binary. Blank = auto-detect.',
      sshMissherPathPlaceholder: 'auto-detect',
      sshTestConnection: 'Test SSH',
      sshConnect: 'Connect',
      sshButtonsHint: 'Save applies on the next launch. Connect reconnects now.',
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Missher found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Missher runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Missher is not installed on the remote host. Install it there (curl -fsSL https://missher-agent.nousresearch.com/install.sh | sh) or set the Missher path.',
      sshErrPlatform:
        'Unsupported remote platform. Missher Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Missher on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Missher. Review the exact configuration below — it comes from the link, not from Missher.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Missher starts and manages the server for you.`,
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Missher ships.`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Missher runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Missher at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Missher browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via missher curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Missher (default)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'This backend predates key-addressed plugin toggles — update Missher to manage it here.',
      ...
      catalogProvenance: (sha: string) => `Installed from the Missher catalog${sha ? ` at pin ${sha}` : ''}.`,
  ...
  starmap: {
    ...
    emptyDesc: 'As Missher builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Missher to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Missher to generate pets.',
      backgroundHint: 'You can close this — Missher will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Missher desktop' },
    ...
    missherActiveSessions: (version, count) => `Missher ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle: 'Both options connect a bot you control and save its credentials only to this Missher installation.',
      quickSetup: 'Quick setup',
      recommended: 'Recommended',
      quickHelp:
        'Scan a QR code and confirm in Telegram. Missher creates the bot and detects your Telegram user ID automatically.',
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@missher:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Missher you point it at, instead of this computer.',
      urlLabel: 'Remote address',
      urlPlaceholder: 'https://missher.example.com',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Missher environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Missher did not save that model change.',
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Missher will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Missher backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Missher. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Missher backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Missher...',
    placeholderReconnecting: 'Reconnecting to Missher…',
    ...
    voiceEngineChained: 'Speech-to-text + Missher voice',
    voiceEngineLive: 'GPT-Live (full-duplex, delegates to Missher)',
    ...
    attachUrlDesc: 'Missher will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Missher to open PR',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Missher…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Missher…',
    ...
    unsupportedMessage: 'This version of Missher can’t update itself from inside the app.',
    ...
    manualBody: 'You installed Missher from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Missher will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Missher desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Missher updater takes over in its own window and reopens Missher automatically when it’s done. Please don’t reopen Missher yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Missher reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Missher reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Missher?',
    blockerBody:
      'Missher needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Missher',
    foreignBlockerBody:
      'Missher can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Missher can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Missher is one click away',
    stayText: 'Switch to the setup profile and open Welcome to Missher whenever you want a hand. It stays there.'
  },
  guidedGreeting: {
    line: "Hey, come on in. I'm Missher. Give me two minutes to set the place up around you, then we'll put me to work on something you actually want done.\n\nFirst though, what should I call you?",
  ...
  install: {
    ...
    oneTimeTitle: 'Missher needs a one-time install',
    ...
    setupChoiceTitle: 'Set up Missher Desktop',
    setupChoiceDesc:
      'Connect this app to a Missher gateway you already run, or install Missher locally on this computer.',
    connectExistingTitle: 'Connect to existing Missher',
    ...
    installLocalTitle: 'Install Missher locally',
    installLocalDesc: 'Download Missher, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Missher Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Missher',
    remoteSetupDesc: 'Enter your gateway URL. Missher Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Missher gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/missher',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Missher gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Missher Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Missher CLI or desktop instance is running. Stop any running Missher instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Missher Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Missher is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Missher…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Missher',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Missher at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Missher connects automatically',
    ...
    authorizeThere: 'Authorize Missher there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Missher there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    alreadySignedInBody: 'This Missher is already signed in to a Nous account.'
  },
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `Missher Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `Missher Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Missher will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Missher is restarting...',
      askRestart: 'Ask Missher to restart the server',
      lookingRestart: taskId => `Missher is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Missher is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Missher to open a page.',
      finishedRestarting: message => `Missher finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Missher could not restart the server.',
      stillWorking:
        'Missher is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Missher is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Missher gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.missher/config.yaml). Missher won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Missher needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Missher needs a credential to continue.',
    ...
    vaultSaveDesc: origin =>
      `Missher reached a sign-in page at ${origin} and has no login for it. Enter it once here; it is encrypted on this machine and filled into the page without the model ever seeing the password.`,
    ...
    vaultCodeDesc: site =>
      `${site} is asking for a one-time code (text message, email or authenticator app). Enter it here and Missher types it into the page; the model never sees it.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      'Tip: save the authenticator key with this login in Settings → Passwords & Logins and Missher enters codes for you.',
    vaultCodeSkip: 'Skip',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Missher Desktop to use Save Image.',
    restartToSaveImages: 'Restart Missher Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `missher gateway` running?'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Missher loads when the work calls for them.'
      },
      messaging: {
        title: 'Missher away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Missher made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Missher — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
