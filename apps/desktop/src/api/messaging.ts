...
export function getMessagingPlatforms(profile?: null | string): Promise<MessagingPlatformsResponse> {
  return missherApi<MessagingPlatformsResponse>({
...
export function updateMessagingPlatform(
  ...
  return missherApi<MessagingPlatformUpdateResponse>({
    ...profileScoped(profile),
...
export function testMessagingPlatform(
  ...
  return missherApi<MessagingPlatformTestResponse>({
    ...profileScoped(profile),
...
export function startTelegramOnboarding(
  ...
  return missherApi<TelegramOnboardingStartResponse>({
    ...profileScoped(profile),
...
export function getTelegramOnboardingStatus(
  ...
  return missherApi<TelegramOnboardingStatusResponse>({
    ...profileScoped(profile),
...
export function applyTelegramOnboarding(
  ...
  return missherApi<TelegramOnboardingApplyResponse>({
    ...profileScoped(profile),
...
export function getPairing(profile?: null | string): Promise<PairingResponse> {
  return missherApi<PairingResponse>({
    ...profileScoped(profile),
    path: '/api/pairing'
  })
}
...
export function approvePairing(
  ...
  return missherApi<{ ok: boolean; user: PairingUser }>({
    ...profileScoped(profile),
...
export function getWebhooks(): Promise<WebhooksResponse> {
  return missherApi<WebhooksResponse>({
    ...profileScoped(),
    path: '/api/webhooks'
  })
}
...
export function enableWebhooks(): Promise<WebhookEnableResponse> {
  return missherApi<WebhookEnableResponse>({
    ...profileScoped(),
...
export function createWebhook(body: WebhookCreatePayload): Promise<WebhookCreateResponse> {
  return missherApi<WebhookCreateResponse>({
    ...profileScoped(),
    path: '/api/webhooks',
    method: 'POST',
    body
...
export function setWebhookEnabled(
  ...
  return missherApi<{ enabled: boolean; name: string; ok: boolean }>({
    ...profileScoped(),
