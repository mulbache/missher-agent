...
import type * as MissherApi from '@/missher'
...
vi.mock('@/missher', async importOriginal => ({
  ...(await importOriginal<typeof MissherApi>()),
...
describe('SkillsView toolset management', { timeout: 60_000 }, () => {
    ...
    await act(async () => {
      window.dispatchEvent(
        new MessageEvent('message', {
          data: { type: 'missher-skill-pick', name: 'web-research', identifier: 'web-research' },
          origin: 'https://missher-agent.nousresearch.com'
        })
      )
    })
  ...
  it('offers (connection, profile) scope rows on multi-connection desktops', async () => {
    ...
    ;(window as { missherDesktop?: unknown }).missherDesktop = { connections, getAgentRoster }
