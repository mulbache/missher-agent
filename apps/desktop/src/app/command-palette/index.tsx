...
import { getMissherConfigRecord, listAllProfileSessions } from '@/missher'
...
// Missher session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: () => getMissherConfigRecord()
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-missher',
            keywords: ['update', 'upgrade', 'missher', 'version', 'system', 'restart'],
            label: cc.updateMissher,
