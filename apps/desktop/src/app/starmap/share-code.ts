...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/missher'
...
const VERSION = 3
const PREFIX = 'HML' // "Missher Memory Loadout" — namespaces our codes like WoW's leading bytes.
