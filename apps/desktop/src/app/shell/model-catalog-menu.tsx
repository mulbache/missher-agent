import type { ModelOptionProvider, ModelOptionsResult } from '@missher/shared'
import { DEFAULT_REASONING_EFFORT } from '@missher/shared'
...
import { getLocalModelsStatus } from '@/missher'
...
import type { LocalModelLoadProgress } from '@/types/missher'
 ...
 * Returning `{}` is fine — the row then shows Missher' defaults.
 */
