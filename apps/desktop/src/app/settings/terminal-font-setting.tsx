...
function fontFamilyFromConfig(config: MissherConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const [staleConfig, setStaleConfig] = useState<MissherConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setMissherConfigCache, so
    ...
    const timeout = window.setTimeout(() => {
      ...
      void saveMissherConfig(setNested({}, 'terminal.font_family', value))
        .then(result => {
          if (!result.ok) {
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="missher-terminal-font-families"
          ...
          <datalist id="missher-terminal-font-families">
