...
const RELEASE_NOTES_URL = 'https://github.com/NousResearch/missher-agent/releases'
const INSTALLER_URL = 'https://missher-agent.nousresearch.com/'
              ...
              <div className="min-w-0">
                {version?.bundleSwapPending ? (
                  ...
                  <>
                    ...
                    <Button
                      className="mt-2"
                      onClick={() => void window.missherDesktop?.relaunchApp?.()}
                      size="sm"
                      variant="textStrong"
                    >
                    ...
                    <Button asChild className="mt-2" size="sm" variant="textStrong">
                      <a
                        ...
                        onClick={event => {
                          ...
                          void window.missherDesktop?.openExternal?.(INSTALLER_URL)
                        }}
                        rel="noreferrer"
                        target="_blank"
                      >
          ...
          <div className="mt-3 flex flex-wrap items-center gap-4">
            ...
            <Button asChild className="ml-auto" size="sm" variant="text">
              <a
                ...
                onClick={event => {
                  event.preventDefault()
                  void window.missherDesktop?.openExternal?.(RELEASE_NOTES_URL)
                }}
                rel="noreferrer"
                target="_blank"
              >
