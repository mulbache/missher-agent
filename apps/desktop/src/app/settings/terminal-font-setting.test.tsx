...
vi.mock('@/missher', () => ({
  saveMissherConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setMissherConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
