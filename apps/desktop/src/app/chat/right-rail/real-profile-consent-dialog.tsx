...
import { saveMissherConfigRecord } from '@/missher'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config } = useMissherConfigRecord()
  const setConfig = missherConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveMissherConfigRecord({ browser: { use_real_profile: true } })
