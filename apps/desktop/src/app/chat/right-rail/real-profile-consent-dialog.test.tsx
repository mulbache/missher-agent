...
vi.mock('@/missher', () => ({
  saveMissherConfigRecord: (config: Record<string, unknown>, profile?: unknown) => mocks.save(config, profile)
}))

const promptCopy = {
  title: 'Stay signed in to your sites',
  body: 'Let Missher browse with a snapshot of your default browser profile.',
...
vi.mock('../../hooks/use-config-record', () => ({
  missherConfigCacheWriter: () => (config: Record<string, unknown>) => mocks.cache(config),
  useMissherConfigRecord: () => ({ data: mocks.loadedConfig })
}))
