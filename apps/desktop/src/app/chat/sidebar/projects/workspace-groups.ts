...
import type { ProjectInfo, SessionInfo } from '@/missher'
 ...
 * repo shows its branches/worktrees even when they have no Missher sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: MissherGitWorktree[]
): SidebarSessionGroup[] {
