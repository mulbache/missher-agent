...
import type { MissherGitBranch } from '@/global'
...
const branchActionLabel = (branch: MissherGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<MissherGitBranch[]>([])
  ...
  const convert = async (branch: MissherGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
