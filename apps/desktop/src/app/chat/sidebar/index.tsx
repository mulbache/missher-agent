...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/missher'
...
// highlight markers (sqlite snippet() delimiters — see missher_state_search.py).
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('missher:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('missher:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask Missher to
