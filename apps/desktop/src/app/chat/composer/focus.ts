...
const FOCUS_EVENT = 'missher:composer-focus'
const INSERT_EVENT = 'missher:composer-insert'
const ATTACH_IMAGES_EVENT = 'missher:composer-attach-images'
const INSERT_REFS_EVENT = 'missher:composer-insert-refs'
const SUBMIT_EVENT = 'missher:composer-submit'
const VOICE_TOGGLE_EVENT = 'missher:composer-voice-toggle'
const MODEL_MENU_EVENT = 'missher:composer-model-menu'
