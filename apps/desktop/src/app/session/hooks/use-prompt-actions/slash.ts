import { skillInvocationText } from '@missher/shared'
import { parseCommandDispatch, parseSlashCommand } from '@missher/shared'
import { type MutableRefObject, useCallback, useRef } from 'react'

import { getProfiles } from '@/missher'
  ...
  return useCallback(
    async (rawCommand: string, options?: { sessionId?: string; recordInput?: boolean }) => {
      ...
      const actionHandlers: Record<DesktopActionId, (ctx: SlashActionCtx) => Promise<void>> = {
        ...
        // lease. Sending it through slash.exec creates a separate MissherCLI in
