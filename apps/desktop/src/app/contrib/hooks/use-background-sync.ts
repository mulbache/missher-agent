...
import { getLatestSessionMessages, type ProfileScope } from '@/missher'
...
interface BackgroundSyncParams {
  ...
  refreshMissherConfig: () => Promise<unknown> | unknown
...
export function useBackgroundSync({
  ...
  }, [activeSessionId, freshDraftReady, gatewayState, refreshCurrentModel, refreshMissherConfig])
}
