import type { MissherReviewFile } from '@/global'
...
export function buildReviewFlatList(files: MissherReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: MissherReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
