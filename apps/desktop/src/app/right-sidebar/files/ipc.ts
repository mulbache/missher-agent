...
import type { MissherReadDirEntry, MissherReadDirResult } from '@/global'
...
export type ProjectTreeEntry = MissherReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: MissherReadDirEntry) {
...
async function filterIgnored(entries: MissherReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<MissherReadDirResult> {
