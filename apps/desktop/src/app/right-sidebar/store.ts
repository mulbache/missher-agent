...
const TAKEOVER_KEY = 'missher.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which Missher can't clear via the API — the user
 *  sees exactly what runs instead of Missher silently deleting their creds. */
