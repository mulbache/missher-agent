...
// (#73044). Exercises the REAL missher + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/missher')
...
const conn = (over: Partial<MissherConnection> = {}): MissherConnection =>
  ({
    authMode: 'oauth',
