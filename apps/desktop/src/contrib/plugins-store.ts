 ...
 * `<missher home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'missher.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'missher.desktop.disabledPlugins.v1'
