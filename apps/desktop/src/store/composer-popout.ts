...
const POPOUT_STORAGE_KEY = 'missher.desktop.composerPopout.zones.v1'
const POPOUT_GESTURES_ENABLED_STORAGE_KEY = 'missher.desktop.composerPopout.gesturesEnabled'
...
const LEGACY_ENABLED_KEY = 'missher.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'missher.desktop.composerPopout.position'
