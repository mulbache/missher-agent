...
import { getMissherConfigRecord, type McpTestResult, setMcpServerEnabled, testMcpServer } from '@/missher'
...
const SNOOZE_KEY_PREFIX = 'missher:mcp-health-snooze-until:'
...
async function sweep(): Promise<void> {
  ...
  try {
    config = await getMissherConfigRecord()
  } catch {
