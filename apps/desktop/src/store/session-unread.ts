...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('missher.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('missher.desktop.unreadFinishedSessions')
