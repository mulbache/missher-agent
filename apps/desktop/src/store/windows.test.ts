...
function installBridge(
  openSessionWindow?: Window['missherDesktop']['openSessionWindow'],
  openWindow?: Window['missherDesktop']['openWindow'],
  openBrowserWindow?: Window['missherDesktop']['openBrowserWindow']
) {
