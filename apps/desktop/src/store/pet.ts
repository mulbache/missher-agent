...
export interface PetInfo {
  ...
  // the Missher "run" activity state uses the in-place running row).
 ...
 * MISSHER_HOME — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'missher.desktop.pet-roam.v1'
