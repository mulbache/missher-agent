...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://missher.example.com:8443/x')).toBe('missher.example.com:8443')
    expect(remoteHostLabel('https://missher.example.com:443')).toBe('missher.example.com')
    expect(remoteHostLabel('http://missher.example.com:80')).toBe('missher.example.com')
  })
