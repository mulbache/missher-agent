...
function identityForConnection(connection: MissherConnection | null): string {
  if (!connection) {
    return ''
  }
...
export function syncCronModelImpactConnection(connection: MissherConnection | null): void {
