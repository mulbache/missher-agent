...
// v1 (`missher.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'missher.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'missher.desktop.statusbarHidden'
// v1 (`missher.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'missher.desktop.statusbarVisible.v2'
