...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @missher/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@missher/shared'],
              message: 'Plugins import only @missher/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
