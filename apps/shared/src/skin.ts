/**
 * Canonical Missher skin — the theme SDK's cross-surface contract.
 *
 * A skin is authored once as YAML in `$MISSHER_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`missher_cli/skin_engine.py`),
 ...
 *   • CLI     → `missher_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
